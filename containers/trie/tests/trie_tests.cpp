...
{
  auto words = words_from_node( *root );
  auto expected = std::vector<std::string>{ "aid", "ab", "abo", "abot", "aba", "bra", "braid", "baka" };
...
TEST_F( trie_node_tests, delete_baka_braid )
{
  ...
  auto words = words_from_node( *root );
  auto expected = std::vector<std::string>{ "aid", "ab", "abo", "abot", "aba", "bra" };
  ASSERT_EQ( words, expected );
}
...
TEST_F( trie_node_tests, delete_inter_trie_words )
{
  ...
  auto words = words_from_node( *root );
  auto expected = std::vector<std::string>{ "aid", "abo", "abot", "aba", "bra", "braid", "baka" };
  ASSERT_EQ( words, expected );
}
